...
class Controller extends Object {
    ...
    function getLanguage() {
        return (!empty($_SESSION[$this->default_product][$this->default_language])) ? $_SESSION[$this->default_product][$this->default_language] : 'en';
    }
    ...
    function getUserTeamId() {
        return isset($_SESSION[$this->default_user]) && array_key_exists('team_id', $_SESSION[$this->default_user]) ? $_SESSION[$this->default_user]['team_id'] : false;
    }
