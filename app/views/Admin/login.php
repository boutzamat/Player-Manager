...
<div class="login-box">
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=Admin&amp;action=login" method="post" id="frmLoginAdmin" class="cms-form">
		<input type="hidden" name="login_user" value="1" />
		<p><label class="title"><?php echo $CMS_LANG['login_email']; ?>:</label><input name="login_email" type="text" class="text w300" id="login_email" /></p>
		<p><label class="title"><?php echo $CMS_LANG['login_password']; ?>:</label><input name="login_password" type="password" class="text w300" id="login_password" /></p>
