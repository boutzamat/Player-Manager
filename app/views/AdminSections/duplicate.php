...
if (isset($tpl['status']))
{
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1"><?php echo $CMS_LANG['section_duplicate']; ?></a></li>
		</ul>
		<div id="tabs-1">

			<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminSections&amp;action=duplicate" method="post" id="frmCreateSection" class="cms-form">
				<input type="hidden" name="section_duplicate" value="1" />
				<p><label class="title"><?php echo $CMS_LANG['section_name']; ?></label><input type="text" name="section_name" id="section_name" lang="<?php echo $CMS_LANG['required_field'];?>"  value = "<?php echo $tpl['arr']['section_name']; ?>" class="text w300 required" /></p>
