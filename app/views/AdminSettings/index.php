...
if (isset($tpl['status'])) {
    ...
    <div id="settingsTab"> <!-- id="tabs" class="tab-user-general" -->    
        <ul class="nav nav-tabs" role="tablist">
            <li class="active" role="presentation"><a href="#tabs-1" aria-controls="home" role="tab" data-toggle="tab"><?php echo $CMS_LANG['settings_teams']; ?></a></li>
			<li class="" role="presentation"><a href="#tabs-2" aria-controls="home" role="tab" data-toggle="tab"><?php echo $CMS_LANG['settings_groups']; ?></a></li>
        </ul>
