...
if (!defined("SCRIPT_VERSION")) define("SCRIPT_VERSION", "4.0");
if (!defined("SCRIPT_ID")) define("SCRIPT_ID", "17");
if (!defined("SCRIPT_BUILD")) define("SCRIPT_BUILD", "4.0.0");
